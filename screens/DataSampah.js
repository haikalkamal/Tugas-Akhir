    ...
    return (
        <View>
            <View style={{ marginTop: 0, marginLeft: 2, backgroundColor: '#FFFFFF', width: 390, height: 800, borderRadius: 1 }}>
                <Text style={{ fontSize: 14, marginTop: 25, fontWeight: '500', marginLeft: 20, color: '#000000', }}>Masukkan Data Sampah</Text>
                <View style={{ marginTop: 25, marginLeft: 33, backgroundColor: '#FFFFFF', width: 325, height: 80, borderWidth: 1, borderColor: '#C4C4C4', borderRadius: 14 }}>
                    ...
                    <Text style={{ fontSize: 10, marginLeft: 60, marginTop: 3, fontWeight: '300', textAlign: 'left', color: '#000000', }}>Rp 1500/g</Text>
                    <Text style={{ fontSize: 10, marginLeft: 60, marginTop: 3, fontWeight: '300', textAlign: 'left', color: '#000000', }}>2 g</Text>
                    ...
                    <View style={{ marginTop: 30, marginLeft: -3, backgroundColor: '#FFFFFF', width: 325, height: 80, borderWidth: 1, borderColor: '#C4C4C4', borderRadius: 14 }}>
                        ...
                        <Text style={{ fontSize: 10, marginLeft: 60, marginTop: 3, fontWeight: '300', textAlign: 'left', color: '#000000', }}>Rp 1000/g</Text>
                        <Text style={{ fontSize: 10, marginLeft: 60, marginTop: 3, fontWeight: '300', textAlign: 'left', color: '#000000', }}>1 g</Text>
                        ...
                        <View style={{ marginTop: 30, marginLeft: -2, backgroundColor: '#FFFFFF', width: 325, height: 80, borderWidth: 1, borderColor: '#C4C4C4', borderRadius: 14 }}>
                            ...
                            <Text style={{ fontSize: 10, marginLeft: 60, marginTop: 3, fontWeight: '300', textAlign: 'left', color: '#000000', }}>Rp 2000/g</Text>
                            <Text style={{ fontSize: 10, marginLeft: 60, marginTop: 3, fontWeight: '300', textAlign: 'left', color: '#000000', }}>4 g</Text>
