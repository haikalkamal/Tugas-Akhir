...
const KelolaProfil = () => {
    ...
    const onUbahProfilPetugasPress = () => {
        navigation.navigate('UbahProfilPetugas');
    };
...
return (
    <View style={styles.root}>
        ...
        <CustomButton
                text="Ubah"
                onPress={onUbahProfilPetugasPress}
                bgColor="transparent"
                fontWeight= '400' 
                marginTop={363}
                marginLeft={102}
...
const Component2 = () => {
    return (
        <View>
            ...
            <Text style={{ fontSize: 13, marginTop: 7, fontWeight: '400', marginLeft: 15, color: '#4F4F4F', }}>Muhammad Aliyudin S</Text>
            ...
            <Text style={{ fontSize: 13, marginTop: 7, fontWeight: '400', marginLeft: 15, color: '#4F4F4F', }}>Jalan Banteng, RT 03/RW 13</Text>
            <View style={{marginLeft: -1, marginRight: 15, marginTop: 20, backgroundColor: '#FFFFFF', borderColor:'#C4C4C4', borderWidth: 1, borderRadius: 8, height: 35, width: 250}}>
            ...
            <View style={{marginLeft: -1, marginRight: 15, marginTop: 20, backgroundColor: '#FFFFFF', borderColor:'#C4C4C4', borderWidth: 1, borderRadius: 8, height: 35, width: 250}}>
            <Text style={{ fontSize: 13, marginTop: 7, fontWeight: '400', marginLeft: 15, color: '#4F4F4F', }}>Aliyudin@mail.com</Text>
            <View style={{marginLeft: -1, marginRight: 15, marginTop: 20, backgroundColor: '#FFFFFF', borderColor:'#C4C4C4', borderWidth: 1, borderRadius: 8, height: 35, width: 250}}>
            <Text style={{ fontSize: 13, marginTop: 7, fontWeight: '400', marginLeft: 15, color: '#4F4F4F', }}>0898 - 8989 - 8989</Text>
            <View style={{marginLeft: -1, marginRight: 15, marginTop: 20, backgroundColor: '#FFFFFF', borderColor:'#C4C4C4', borderWidth: 1, borderRadius: 8, height: 35, width: 250}}>
            <Text style={{ fontSize: 13, marginTop: 7, fontWeight: '400', marginLeft: 15, color: '#4F4F4F', }}>B 2345 SJE</Text>
